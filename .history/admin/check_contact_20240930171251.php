...
$messages = $controller->getMessages(); // Fetch messages from your database

// Handle deletion
if (isset($_GET['delete_id'])) {
    $controller->deleteMessage($_GET['delete_id']); // Delete message by ID
    header("Location: check_contact.php"); // Redirect after deletion
    exit();
}
?>
