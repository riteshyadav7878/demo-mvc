<?php
// check_contact.php
include '../controller/controller.php'; // Make sure this path is correct

// Database connection (make sure to replace with your actual connection logic)
...
// Now you can use $submissions for your logic (e.g., displaying in a table)
?>
