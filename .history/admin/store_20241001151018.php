...
$items = $userController->getItems(); // Ensure getItems() fetches the items correctly
...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
            <?php if (isset($items) && $items->num_rows > 0): ?>
                <?php $sr_no = 1; ?>
                ...
                <div class="modal-body">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="editItemDescription" name="editItemDescription" rows="3" required></textarea>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const messages = <?php echo json_encode($messages ?? []); ?>; // Handle messages safely
