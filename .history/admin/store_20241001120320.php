...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id']) && isset($_POST['itemTitle'])) {
    $stmt = $conn->prepare("UPDATE shopping_items SET title=?, description=?, price=?, status=? WHERE id=?");
    $stmt->bind_param("ssdsi", $_POST['itemTitle'], $_POST['itemDescription'], $_POST['itemPrice'], $_POST['itemStatus'], $_POST['id']);
...
// Handle delete, activate/deactivate actions
// ... (existing code for handling delete, activate/deactivate) ...
