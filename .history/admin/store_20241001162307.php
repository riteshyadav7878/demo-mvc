<?php
include '../conn.php';
include '../app/controllers/ShoppingController.php';

$controller = new ShoppingController($conn);
list($items, $messages) = $controller->handleRequest();

include '../app/views/shopping_view.php';
$conn->close();
?>
