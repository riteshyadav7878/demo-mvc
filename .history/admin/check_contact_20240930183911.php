<?php
include '../userside/conn.php';  // Include the database connection
 
include '../userside/controller/controller.php';  // Include controller
include '../userside/model/model.php';  // Adjust the path if necessary
...
<body>
<?php include '../userside/navbar.php'; ?> <!-- Correct the path if needed -->
<div class="container mt-5">
    ...
    <?php include '../userside/footer.php'; ?> <!-- Correct the path if needed -->
</div>
