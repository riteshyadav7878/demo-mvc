...
// Prepare image URL; fallback to a default image if not found
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Description:</strong> <?php echo htmlspecialchars($itemDetails['description']); ?></p>
